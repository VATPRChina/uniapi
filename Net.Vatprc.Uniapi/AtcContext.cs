...
public class AtcContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("idx_241864_primary");

            entity.ToTable("applications", "vatprc_atc");

            entity.HasIndex(e => e.Applicant, "idx_241864_applications_applicant_foreign");
        ...
        {
            entity.HasKey(e => e.Id).HasName("idx_241872_primary");

            entity.ToTable("applications_interviews", "vatprc_atc");

            entity.HasIndex(e => e.ApplicationId, "idx_241872_applications_interviews_application_id_foreign");

            entity.HasIndex(e => e.Interviewer, "idx_241872_applications_interviews_interviewer_foreign");
        ...
        {
            entity.HasKey(e => e.ApplicationId).HasName("idx_241878_primary");
        ...
        {
            entity.HasKey(e => e.Id).HasName("idx_241884_primary");
        ...
        {
            entity.HasKey(e => e.Id).HasName("idx_241893_primary");

            entity.ToTable("events_positions", "vatprc_atc");

            entity.HasIndex(e => e.EventId, "idx_241893_events_positions_event_id_foreign");

            entity.HasIndex(e => e.Requirement, "idx_241893_events_positions_requirement_foreign");
        ...
        {
            entity.HasKey(e => e.EventsPositionId).HasName("idx_241899_primary");

            entity.ToTable("events_positions_bookings", "vatprc_atc");

            entity.HasIndex(e => e.Controller, "idx_241899_events_positions_bookings_controller_foreign");
        ...
        {
            entity.HasKey(e => e.Id).HasName("idx_241905_primary");

            entity.ToTable("failed_jobs", "vatprc_atc");

            entity.HasIndex(e => e.Uuid, "idx_241905_failed_jobs_uuid_unique").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("idx_241913_primary");

            entity.ToTable("jobs", "vatprc_atc");

            entity.HasIndex(e => e.Queue, "idx_241913_jobs_queue_index");
        ...
        {
            entity.HasKey(e => e.Id).HasName("idx_241920_primary");
        ...
        {
            entity.HasKey(e => e.Id).HasName("idx_241925_primary");
        ...
        {
            entity.HasKey(e => e.Id).HasName("idx_241932_primary");
        ...
        {
            entity.HasKey(e => new { e.ParentId, e.ChildrenId }).HasName("idx_241938_primary");

            entity.ToTable("roles_inheritances", "vatprc_atc");

            entity.HasIndex(e => e.ChildrenId, "idx_241938_roles_inheritances_children_id_foreign");
        ...
        {
            entity.HasKey(e => new { e.RoleId, e.PermissionId }).HasName("idx_241943_primary");

            entity.ToTable("roles_permissions", "vatprc_atc");

            entity.HasIndex(e => e.PermissionId, "idx_241943_roles_permissions_permission_id_foreign");
        ...
        {
            entity.HasKey(e => e.Id).HasName("idx_241949_primary");

            entity.ToTable("schedules", "vatprc_atc");

            entity.HasIndex(e => e.UserId, "idx_241949_schedules_user_id_foreign");
        ...
        {
            entity.HasKey(e => e.Id).HasName("idx_241956_primary");

            entity.ToTable("trains", "vatprc_atc");

            entity.HasIndex(e => e.Instructor, "idx_241956_trains_instructor_foreign");
        ...
        {
            entity.HasKey(e => e.Id).HasName("idx_241968_primary");

            entity.ToTable("train_comments", "vatprc_atc");

            entity.HasIndex(e => e.Author, "idx_241968_train_comments_author_foreign");

            entity.HasIndex(e => e.LastEditor, "idx_241968_train_comments_last_editor_foreign");

            entity.HasIndex(e => e.Train, "idx_241968_train_comments_train_foreign");
        ...
        {
            entity.HasKey(e => e.Id).HasName("idx_241975_primary");

            entity.ToTable("train_requests", "vatprc_atc");

            entity.HasIndex(e => e.Student, "idx_241975_train_requests_student_foreign");

            entity.HasIndex(e => e.TrainId, "idx_241975_train_requests_train_id_foreign");
        ...
        {
            entity.HasKey(e => e.Id).HasName("idx_241983_primary");

            entity.ToTable("train_requests_periods", "vatprc_atc");

            entity.HasIndex(e => e.TrainRequestId, "idx_241983_train_requests_periods_train_request_id_foreign");
        ...
        {
            entity.HasKey(e => e.TrainId).HasName("idx_241962_primary");

            entity.ToTable("trains_bookings", "vatprc_atc");

            entity.HasIndex(e => e.ClosedBy, "idx_241962_trains_bookings_closed_by_foreign");

            entity.HasIndex(e => e.Student, "idx_241962_trains_bookings_student_foreign");
        ...
        {
            entity.HasKey(e => e.Id).HasName("idx_241989_primary");
            ...
            entity.HasMany(d => d.Instructors).WithMany(p => p.Students)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("InstructorId", "StudentId").HasName("idx_241995_primary");
                        j.ToTable("users_instructors", "vatprc_atc");
                        j.HasIndex(new[] { "StudentId" }, "idx_241995_users_instructors_student_id_foreign");
        ...
        {
            entity.HasKey(e => new { e.UserId, e.RoleId }).HasName("idx_242000_primary");

            entity.ToTable("users_roles", "vatprc_atc");

            entity.HasIndex(e => e.RoleId, "idx_242000_users_roles_role_id_foreign");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("idx_242005_primary");
