...
namespace Net.Vatprc.Uniapi.Migrations
{
    ...
    [Migration("20240622182315_InitDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Net.Vatprc.Uniapi.Models.Booking", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("EventSlotId")
                        .IsUnique()
                        .HasDatabaseName("ix_booking_event_slot_id");
            ...
            modelBuilder.Entity("Net.Vatprc.Uniapi.Models.Booking", b =>
                {
                    b.HasOne("Net.Vatprc.Uniapi.Models.EventSlot", "EventSlot")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_booking_event_slot_event_slot_id");
