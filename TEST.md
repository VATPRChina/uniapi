...
| PUT    | `/api/atc/trainings/{id}/record`                           | OK      |
| DELETE | `/api/atc/trainings/{id}`                                  | OK      |
...
| GET    | `/api/atc/trainings/applications/{id}`                     | OK      |
| PUT    | `/api/atc/trainings/applications/{id}`                     | OK      |
| GET    | `/api/atc/trainings/applications`                          | OK      |
| POST   | `/api/atc/trainings/applications`                          | OK      |
| GET    | `/api/atc/trainings/finished`                              | OK      |
| GET    | `/api/atc/trainings/record-sheet`                          | OK      |
| POST   | `/api/atc/trainings`                                       | OK      |
...
| DELETE | `/api/events/{event_id}/controllers/{position_id}/booking` | OK      |
| PUT    | `/api/events/{event_id}/controllers/{position_id}/booking` | OK      |
| DELETE | `/api/events/{event_id}/controllers/{position_id}`         | OK      |
| PUT    | `/api/events/{event_id}/controllers/{position_id}`         | OK      |
| GET    | `/api/events/{event_id}/controllers`                       | OK      |
