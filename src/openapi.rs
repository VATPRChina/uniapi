...
#[openapi(
    nest(
        ...
        (path = "/", api = crate::modules::user::routes::auth::ApiDoc),
        (path = "/", api = crate::modules::user::routes::session::ApiDoc),
        (path = "/", api = crate::modules::audit_log::routes::ApiDoc),
        (path = "/", api = crate::modules::user::routes::users::ApiDoc),
        ...
        (path = "/", api = crate::modules::event::routes::airspaces::ApiDoc),
        (path = "/", api = crate::modules::event::routes::slots::ApiDoc),
        (path = "/", api = crate::modules::event::routes::slot_bookings::ApiDoc),
        (path = "/", api = crate::modules::event::routes::atc_positions::ApiDoc),
        (path = "/", api = crate::modules::flight::routes::flights::ApiDoc),
        (path = "/", api = crate::modules::flight::routes::compat::ApiDoc),
        (path = "/", api = crate::modules::navdata::routes::ApiDoc),
        (path = "/", api = crate::modules::sheet::routes::ApiDoc),
        (path = "/", api = crate::modules::storage::ApiDoc),
        (path = "/", api = crate::modules::controller::routes::sectors::ApiDoc),
    ),
