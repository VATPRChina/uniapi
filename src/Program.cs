...
builder.Services.Configure<NavadataAdapter.Option>(builder.Configuration.GetSection(NavadataAdapter.Option.LOCATION));
builder.Services.AddSingleton<NavadataAdapter>();
builder.Services.AddSingleton<INavdataProvider, NavdataProvider>();
