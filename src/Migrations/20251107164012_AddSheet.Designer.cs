...
namespace Net.Vatprc.Uniapi.Migrations
{
    ...
    [Migration("20251107164012_AddSheet")]
    partial class AddSheet
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Net.Vatprc.Uniapi.Models.Sheet.SheetFilingAnswer", b =>
                {
                    ...
                    b.Property<long>("FieldSequence")
                        .HasColumnType("bigint")
                        .HasColumnName("field_sequence");
                    ...
                    b.HasKey("SheetId", "FieldSequence", "FilingId")
            ...
            modelBuilder.Entity("Net.Vatprc.Uniapi.Models.Sheet.SheetFilingAnswer", b =>
                {
                    ...
                    b.HasOne("Net.Vatprc.Uniapi.Models.Sheet.SheetField", "Field")
                        .WithMany()
                        .HasForeignKey("SheetId", "FieldSequence")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_sheet_filing_answer_sheet_field_sheet_id_field_sequence");
