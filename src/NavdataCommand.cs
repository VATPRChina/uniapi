...
public class NavdataCommand : Command
{
    ...
    protected async Task Handle(ParseResult parseResult)
    {
        var serviceUrl = parseResult.GetValue(ServiceUrl) ?? throw new ArgumentNullException(nameof(ServiceUrl));
        var accessKey = parseResult.GetValue(AccessKey) ?? throw new ArgumentNullException(nameof(AccessKey));
        var secretKey = parseResult.GetValue(SecretKey) ?? throw new ArgumentNullException(nameof(SecretKey));
        var arincPath = parseResult.GetValue(ArincPath) ?? throw new ArgumentNullException(nameof(ArincPath));
        var arincLocalPath = parseResult.GetValue(ArincLocalPath) ?? throw new ArgumentNullException(nameof(ArincLocalPath));
        var aipPath = parseResult.GetValue(AipPath) ?? throw new ArgumentNullException(nameof(AipPath));
