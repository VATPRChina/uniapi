...
use crate::repository::event::event_slot_booking::{
    self as booking_repository, EventBookingRecord,
};
...
async fn put_booking(
    ...
    let slot_id = parse_ulid_uuid(&sid, ApiError::bad_request("slot_id", "invalid ULID"))?;
