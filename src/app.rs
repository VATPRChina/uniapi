...
use crate::modules::atc_position::routes::build_atc_position_routes;
...
use crate::modules::controller::routes::user_atc_permissions::build_user_atc_permission_routes;
use crate::modules::event::routes::airspaces::build_event_airspace_routes;
use crate::modules::event::routes::atc_positions::build_event_atc_position_routes;
use crate::modules::event::routes::events::build_event_routes;
use crate::modules::event::routes::slot_bookings::build_event_slot_booking_routes;
use crate::modules::event::routes::slots::build_event_slot_routes;
use crate::modules::flight::routes::compat::build_compat_routes;
use crate::modules::flight::routes::flights::build_flight_routes;
use crate::modules::navdata::routes::build_preferred_route_routes;
use crate::modules::sheet::routes::build_sheet_routes;
use crate::modules::storage::build_storage_routes;
use crate::modules::training::routes::applications::build_training_application_routes;
use crate::modules::training::routes::trainings::build_training_routes;
use crate::modules::user::middleware as auth;
use crate::modules::user::routes::auth::build_auth_routes;
use crate::modules::user::routes::session::build_session_routes;
use crate::modules::user::routes::users::build_user_routes;
...
pub fn router(services: Services) -> Router {
    ...
    let app = Router::new()
        ...
        .nest("/api/atc/positions", build_atc_position_routes())
